...
public class Controller implements Initializable {
    ...
    @Override
    /***
     *  Intializes the chart and database.
     */
    ...
    @FXML
    /***
     * Changes visibility for the plot view and the database
     */
    ...
    @FXML
    /***
     * Adds the current temp datapiece to the database, and updates the chart
     */
    ...
    @FXML
    /***
     * Deletes the selected dataPiece from the database.
     */
    ...
    @FXML
    /***
     * Accesses the database to get the current weather
     */
